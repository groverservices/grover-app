...
const g_ownerData = 'assets/fresco-demo/owner.json';
const g_productsData = 'assets/fresco-demo/products.json';
...
function displayCartOptions(payload){
    ...
    $.getJSON(g_productsData, function(data){
...
function loadOwnerInfo(){
    $.getJSON(g_ownerData,function(json_data){
